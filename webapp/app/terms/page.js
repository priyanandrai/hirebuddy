        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          <div className="rounded-[2rem] border border-slate-800 bg-slate-900/95 p-10 shadow-2xl shadow-slate-950/20">
            ...
            <div className="space-y-8 text-sm text-slate-300 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">2. Our Services</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">4. Helper Responsibilities</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">7. Account Termination</h2>
                <p>
              ...
              <section>
                ...
                <p>
                  ...
                  at <span className="font-medium text-emerald-300">support@hirebuddy.in</span>.
                </p>
              </section>
            </div>
          </div>
