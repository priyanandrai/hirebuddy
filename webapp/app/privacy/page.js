        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          <div className="rounded-[2rem] border border-slate-800 bg-slate-900/95 p-10 shadow-2xl shadow-slate-950/20">
            ...
            <div className="space-y-8 text-sm text-slate-300 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">3. Address & Location Information</h2>
                <p>
                ...
                <p className="mt-2">Address and location data are used strictly for:</p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">4. How We Use Your Information</h2>
                <ul className="list-disc pl-5 space-y-1 text-slate-300">
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">5. OTP & Phone Number Usage</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">6. Payments & Financial Information</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">11. Changes to This Privacy Policy</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">12. Contact Us</h2>
                <p>
                  If you have questions or concerns about this Privacy Policy,
                  please contact us at <span className="font-medium text-emerald-300">support@hirebuddy.in</span>.
                </p>
              </section>
            </div>
          </div>
