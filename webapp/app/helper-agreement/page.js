      ...
      <main className="min-h-screen bg-slate-950 text-slate-100">
        <div className="max-w-4xl mx-auto px-6 py-16">
          <div className="rounded-[2rem] border border-slate-800 bg-slate-900/95 p-10 shadow-2xl shadow-slate-950/20">
            <h1 className="text-3xl font-semibold text-white mb-4">Helper Agreement</h1>
            ...
            <div className="space-y-8 text-sm text-slate-300 leading-relaxed">
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">2. Independent Contractor Relationship</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">3. Helper Responsibilities</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">4. Payments & Earnings</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">5. Cancellations & Service Issues</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">6. Safety & Liability</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">7. Account Suspension or Termination</h2>
                <p>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white mb-2">8. Changes to This Agreement</h2>
                <p>
              ...
              <section>
                ...
                <p>
                  For questions related to this Agreement, contact us at <span className="font-medium text-emerald-300">support@hirebuddy.in</span>.
                </p>
              </section>
            </div>
          </div>
